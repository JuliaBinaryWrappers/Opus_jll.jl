...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Opus_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("91d4177d-7536-5919-b921-800302f37372"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Opus", artifacts_toml) for e in artifacts["Opus"]]
...
if best_platform === nothing
    @debug("Unable to load Opus; unsupported platform $(triplet(platform_key_abi()))")
else
